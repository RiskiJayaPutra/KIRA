<div class="w-full md:w-1/4 bg-background border-4 border-stroke p-6 mb-8 md:mb-0">
    ...
    <nav class="flex flex-col gap-2">
        ...
        <a href="{{ route('wallet') }}" wire:navigate class="font-bold text-lg px-4 py-3 border-2 border-stroke transition-all {{ request()->routeIs('wallet') ? 'bg-button-fomo text-headline shadow-[4px_4px_0px_0px_rgba(39,35,67,1)] -translate-y-1' : 'bg-background hover:bg-secondary' }}">
            My Wallet
        </a>
