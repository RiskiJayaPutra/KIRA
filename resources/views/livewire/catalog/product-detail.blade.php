    ...
    <div class="flex flex-col lg:flex-row gap-12">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center py-8">
            ...
            <div class="flex flex-col gap-4">
                <!-- Add to Cart (Fase 31) -->
                <button wire:click="addToCart" class="group w-full bg-headline text-background font-black text-3xl py-6 border-4 border-stroke shadow-[8px_8px_0px_0px_#ffd803] hover:-translate-y-2 hover:shadow-[12px_12px_0px_0px_#ffd803] active:translate-y-0 active:shadow-none transition-all flex justify-center items-center gap-4">
                    <span>ADD TO CART</span>
                    <x-heroicon-o-shopping-cart class="w-10 h-10 group-hover:-rotate-12 group-hover:scale-110 transition-all" />
                </button>
