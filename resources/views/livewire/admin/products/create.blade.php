<div>
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h2 class="text-4xl font-black text-headline uppercase tracking-tighter" style="-webkit-text-stroke: 1px #272343;">TAMBAH PRODUK</h2>
            <p class="text-xl font-bold text-paragraph">Cetak entitas baru ke dalam katalog.</p>
        </div>
    </div>
    ...
    <form wire:submit="save" class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="w-full lg:w-1/2 space-y-6">
            ...
            <button type="submit" class="w-full bg-button-fomo text-headline font-black text-2xl py-4 border-4 border-stroke shadow-[6px_6px_0px_0px_#272343] hover:-translate-y-1 active:translate-y-0 active:shadow-none transition-all flex justify-center items-center gap-2">
                <x-heroicon-s-cloud-arrow-up class="w-6 h-6" />
